	...
	$
			.extend(
					$.validator,
					{
						...
						messages : {
							required : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>内容不能为空！</b>",
							remote : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请更新这一片区域！</b>",
							email : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>email地址无效，请输入一个正确的email地址！</b>",
							url : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请输入有效的网址",
							date : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>内容只能为日期类型，请填入一个正确的日期！</b>",
							dateISO : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请输入一个有效的ISO文件！</b>",
							number : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>只能为数字，请重新输入内容！</b>",
							digits : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>只能为整数，请重新输入！</b>",
							creditcard : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请输入有效的信用卡号码！</b>",
							equalTo : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>两次内容输入不相同，请重新输入！</b>",
							accept : "<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请输入一个有效的扩展名的值！</b>",
							maxlength : $.validator
									.format("<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>长度不能大于{0} </b>"),
							minlength : $.validator
									.format("<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>长度不能小于{0}</b>"),
							rangelength : $.validator
									.format("<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请输入介于值{0} 和 {1} 之间的字符！</b>"),
							range : $.validator
									.format("<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请输入一个 {0} 和 {1}之间的值！</b>"),
							max : $.validator
									.format("<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请输入一个值小于或等于{0}！</b>"),
							min : $.validator
									.format("<b style='color:red;z-index:10010;position:absolute;background:#FFFFFF;margin-top:-10px;'>请输入一个值大于或等于{0}！</b>")
						},
