...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td>
			<form  method="post"  action="videoAction!saveEdit.action">
				<input type="hidden" name="videoRecordId" value="${a.videoRecordId}"/>
				<table class="STYLEE23" width="100%">
					<tr>
						<td width="30%" style="text-align: right;background-color: #d3eaef; ">设备编码</td>
						<td width="70%" style="text-align: left;"><input name="imei" value="${a.imei}"/></td>
					</tr>
					<tr>
						<td style="text-align: right;background-color: #d3eaef;">视频请求地址</td>
						<td style="text-align: left;"><input name="videoUrl" value="${a.videoUrl}"/></td>
					</tr>
