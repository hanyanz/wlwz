...
<script language="JavaScript" type="text/JavaScript">
   function add(){
       window.open('jsp/video/videoRecordAdd.jsp','新增',
   ...
   function check(str){
	...
	<s:form action="videoAction.action" theme="simple">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         ...
         <td width="200px" ><input name="imei" type="text"/><s:submit value="查询" method ="getVideoinfoList"/></td>
       </tr>
    </table>
	<table>
	 <thead>
	   ...
	   <td style="background-color: #d3eaef;">选择</td>
	    ...
	    <td width="200" height="20" bgcolor="#FFFFFF" class="STYLE19" style="text-align: center;background-color: #d3eaef;">视频请求地址</td>
	   </tr>
	  </thead>
	  <tbody  id="tb">
  	...
  	<c:forEach items="${queryList}" var="temp" varStatus="i">
	  	<label for="c"></label>
	  		<tr id="c" onMouseOver="this.style.background='#d3eaef'" onMouseOut="this.style.background='#ffffff'" onclick="box1()">
	  			<td><input type="checkbox" class="checkbox" value="${temp.videoRecordId}" name="videoRecordId"/></td>
				 <td align="center">${i.count}</td>
				 <td align="center">${temp.imei}</td>
				 <td align="center">${temp.videoUrl}</td>
				 <td> <a href= ${temp.videoUrl} target="rightFrame">查看视频</a></td>
			</tr>
