...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <td>
   <form  method="post"  action="resumerecordAction!saveEdit.action">
   <input type="hidden" name="resumeRecordId" value="${r.resumeRecordId}"/>
<table class="STYLEE23" width="100%">
  <tr>
    <td width="10%" style="text-align: right;background-color: #d3eaef; ">设备编码</td>
    <td width="30%" style="text-align: left;">${r.device.deviceNumber }</td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">所在地点</td>
    <td style="text-align: left;"><input type="text" name="place" value="${r.place}"/></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">时间</td>
    <td style="text-align: left;"><input type="text" name="createTime" value="${r.createTime}"/></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">备注</td>
    <td style="text-align: left;"><textarea id="remark"name="remark" style="width:95%;overflow:auto" rows=""></textarea></td>
  </tr>
  <tr>
