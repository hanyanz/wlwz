...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">新履历记录</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
  ...
  <tr>
   <td>
    <form name="frm" id="frm" method="post"  action="resumerecordAction!createResumeRecord.action">
<table class="STYLEE23" width="100%">
  ...
  <tr>
    ...
    <td style="text-align: left;"><input type="text" name="place" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="text-align: left;"><textarea name="remark" style="width:95%;overflow:auto" rows=""></textarea></td>
  </tr>
  <tr>
