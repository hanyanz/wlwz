...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">新保修记录</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
  ...
  <tr>
   <td>
    <form name="frm" id="frm" method="post"  action="maintenancerecordAction!createMaintenancerecord.action">
<table class="STYLEE23" width="100%">
  ...
  <tr>
    ...
    <td style="text-align: left;"><input type="text" name="maintenancePlace" /></td>
  ...
  <tr>
    ...
    <td style="text-align: left;"><textarea name="maintenanceContent" style="width:95%;overflow:auto" rows=""></textarea></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">注意事项</td>
    <td style="text-align: left;"><textarea name="attentionMatters" style="width:95%;overflow:auto" rows=""></textarea></td>
  </tr>
  <tr>
