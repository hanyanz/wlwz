...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
   <td>
   <form  method="post"  action="handoverrecordAction!saveEdit.action">
   <input type="hidden" name="handoverRecordId" value="${h.handoverRecordId}"/>
<table class="STYLEE23" width="100%">
  <tr>
    <td width="10%" style="text-align: right;background-color: #d3eaef; ">设备编码</td>
    <td width="30%" style="text-align: left;">${h.device.deviceNumber }</td>
  </tr>
    <tr>
    <td style="text-align: right;background-color: #d3eaef;">转出单位</td>
    <td style="text-align: left;"><input type="text" name="transferUnit" value="${h.transferUnit}"/></td>
    <td style="text-align: right;background-color: #d3eaef;">转出单位负责人</td>
    <td style="text-align: left;"><input type="text" name="transferPerson" value="${h.transferPerson}"/></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">接收单位</td>
    <td style="text-align: left;"><input type="text" name="acceptUint" value="${h.acceptUint}"/></td>
    <td style="text-align: right;background-color: #d3eaef;">接收单位负责人</td>
    <td style="text-align: left;"><input type="text" name="acceptPerson" value="${h.acceptPerson}"/></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">时间</td>
    <td style="text-align: left;"><input type="text" name="createTime" value="${h.createTime}"/></td>
  </tr>
  <tr>
