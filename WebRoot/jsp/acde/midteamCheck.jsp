...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">查看中队</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
...
<table class="STYLEE23" width="100%">
  <tr>
    ...
    <td width="70%" style="text-align: left;">${m.midteamName}</td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">所属单位</td>
    <td style="text-align: left;">${m.unitBelonged}</td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">中队负责人</td>
    <td style="text-align: left;">${m.midteamLeader}</td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">联系电话</td>
    <td style="text-align: left;">${m.leaderTele}</td>
  </tr>
</table>
	</td>
	</tr>
