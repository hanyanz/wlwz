...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">查看项目</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
...
<table class="STYLEE23" width="100%">
  <tr>
    ...
    <td width="70%" style="text-align: left;">${p.projectName}</td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">项目地址</td>
    <td style="text-align: left;">${p.projectAddress}</td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">项目负责人</td>
    <td style="text-align: left;">${p.projectLeader}</td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">联系电话</td>
    <td style="text-align: left;">${p.telephone}</td>
  </tr>
</table>
	</td>
	</tr>
