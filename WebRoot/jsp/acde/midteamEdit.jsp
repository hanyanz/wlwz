...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">修改中队信息</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
  ...
  <tr>
   <td>
   <form  method="post"  action="midteamAction!saveEdit.action">
   <input type="hidden" name="midteamId" value="${m.midteamId}"/>
<table class="STYLEE23" width="100%">
 <tr>
    <td width="30%" style="text-align: right;background-color: #d3eaef; ">中队名</td>
    <td width="70%" style="text-align: left;"><input name="midteamName" value="${m.midteamName}"/></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">所属单位</td>
    <td style="text-align: left;"><input name="unitBelonged" value="${m.unitBelonged}"/></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">中队负责人</td>
    <td style="text-align: left;"><input name="midteamLeader" value="${m.midteamLeader}"/></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">联系电话</td>
    <td style="text-align: left;"><input name="leaderTele" value="${m.leaderTele}"/></td>
  </tr>
  <tr>
