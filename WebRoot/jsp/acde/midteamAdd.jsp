...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">新增中队</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
  ...
  <tr>
   <td>
    <form name="frm" id="frm" method="post"  action="midteamAction!createMidteam.action">
<table class="STYLEE23" width="100%">
  <tr>
    <td width="30%" style="text-align: right;background-color: #d3eaef; ">中队名</td>
    <td width="70%" style="text-align: left;">
      <input type="text" name="midteamName" /></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">所属单位</td>
    <td style="text-align: left;"><input  style="width: 80%" name="unitBelonged" /></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">中队负责人</td>
    <td style="text-align: left;"><input type="text" name="midteamLeader" /></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">联系电话</td>
    <td style="text-align: left;"><input type="text" name="leaderTele" /></td>
  </tr>
  <tr>
