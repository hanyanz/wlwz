...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">新增监控参量</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
  ...
  <tr>
   <td>
<form name="frm" id="frm" method="post"  action="depolyAction!createDepoly.action">
<table class="STYLEE23" width="100%">
  <tr>
    <td width="30%" style="text-align: right;background-color: #d3eaef; ">参量名</td>
    <td width="70%" style="text-align: left;">
      <input type="text" name="depolyName" /></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">数据类型</td>
    <td style="text-align: left;"><select name="depolyDataType" id="depolyDataType">
  ...
  <tr>
    ...
    <td style="text-align: left;"><input type="text" name="depolyDataLength" /></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">数值上限</td>
    <td style="text-align: left;"><input type="text" name="depolyUpper" /></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">数值下限</td>
    <td style="text-align: left;"><input type="text" name="depolyLower" /></td>
  </tr>
  <tr>
