...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">修改用户信息</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
  ...
  <tr>
   <td>
   <form  method="post"  action="userAction!saveEdit.action">
   <input type="hidden" name="userId" value="${user.userId}"/>
<table class="STYLEE23" width="100%">
 <tr>
    <td width="10%" style="text-align: right;background-color: #d3eaef; ">用户名</td>
    <td width="30%" style="text-align: left;"><input type="text" name="userName" value="${user.userName}"/></td>
    <td width="10%" style="text-align: right;background-color: #d3eaef; ">角色</td>
    <td width="30%" style="text-align: left;">
    <select name="systemRoleId">
    	<option value="${user.systemrole.systemRoleId}">${user.systemrole.roleName}</option>
   ...
   <tr>
    ...
    <td width="30%" style="text-align: left;"><input type="text" name="realName" value="${user.realName}"/></td>
    <td width="10%" style="text-align: right;background-color: #d3eaef; ">所在单位</td>
    <td width="30%" style="text-align: left;"><input type="text" name="unit" value="${user.unit}"/></td>
  </tr>
   <tr>
    <td width="10%" style="text-align: right;background-color: #d3eaef; ">联系手机</td>
    <td width="30%" style="text-align: left;"><input type="text" name="mobilephone" value="${user.mobilephone}"/></td>
    <td width="10%" style="text-align: right;background-color: #d3eaef; ">联系电话</td>
    <td width="30%" style="text-align: left;"><input type="text" name="telephone" value="${user.telephone}"/></td>
  </tr>
  <tr>
  	<td width="10%" style="text-align: right;background-color: #d3eaef; ">邮箱</td>
    <td width="30%" style="text-align: left;"><input type="text" name="email" value="${user.email}"/></td>
  	<td width="10%" style="text-align: right;background-color: #d3eaef; ">所在地区</td>
    <td width="30%" style="text-align: left;"><input type="text" name="area" value="${user.area}"/></td>
  </tr>
  <tr>
