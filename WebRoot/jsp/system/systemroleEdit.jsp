...
window.onload = function init(){
	document.getElementById("r").value = "${role.remark}";
	}
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="24" bgcolor="#7B68EE "><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="98%" valign="bottom" align="left"><span class="STYLE1">修改角色信息</span></td>
              </tr>
            </table></td>
              </tr>
        </table></td>
  ...
  <tr>
   <td>
   <form  method="post"  action="systemroleAction!saveEdit.action">
   <input type="hidden" name="systemRoleId" value="${role.systemRoleId}"/>
<table class="STYLEE23" width="100%">
 <tr>
    <td width="30%" style="text-align: right;background-color: #d3eaef; ">角色名</td>
    <td width="70%" style="text-align: left;"><input name="roleName" value="${role.roleName}"/></td>
  </tr>
  <tr>
    <td style="text-align: right;background-color: #d3eaef;">备注</td>
    <td style="text-align: left;"><textarea id="r" name="remark" style="width:95%;overflow:auto" rows=""></textarea></td>
  </tr>
  <tr>
