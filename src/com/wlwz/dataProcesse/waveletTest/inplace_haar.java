...
import com.wlwz.dataProcesse.waveletTest.wavelet_util.*;
...
<p>
   The inplace_haar class calculates an in-place Haar waveletTest
...
<p>
   The Haar waveletTest calculation is awkward when the data values are
...
<p>
   ...
   is an iron rule.  The Haar in-place waveletTest transform is more
...
<p>
  Each of these index sets represents a Haar waveletTest frequency (here
  they are listed from the highest frequency to the lowest).

  @author Ian Kaplan

 */
public class inplace_haar extends WaveletBase {
  /** result of calculating the Haar waveletTest */
   ...
   *
<p>
   Calculate the in-place Haar waveletTest function.  The
...
<p> 
   For example, Haar waveletTest the calculation with the data set
...
<b>5</b>  1  0 -2 -3  1 -1  0
   ...
   @param values
      ...
      Haar waveletTest function will be calculated.  The
...
<p>
   Calculate the Haar waveletTest spectrum

<p> 
   Wavelet calculations sample a signal via a window.  In the case of
   the Haar waveletTest, this window is a rectangle.  The signal is
...
<p>
   In the case of the Haar waveletTest, the window is initially two values
...
<p>
   ...
   *
     ...
     Print the result of the Haar waveletTest function.
...
<p>
     ...
     Order the result of the in-place Haar waveletTest function,
...
<p>
     The results in the same ordering as the ordered Haar waveletTest
     transform.
...
<p>
   ...
   *
<p>
     Regenerate the data from the Haar waveletTest function.
