//
//package com.wlwz.dataProcesse.waveletTest.wavelet_util;
//
//import java.io.*;
//
///**
...
//
//<p>
//  The class outputs a Haar waveletTest spectrum array in a format
//  that can be read by gnuplot for 3D plotting.  This function
//  can be used to plot either Haar waveletTest spectrums or
//  Haar waveletTest coefficients.
//
//<p>
...
//In the case of the waveletTest coefficients, the first value will
//be the average for the entire sample.  In either case this
//value will not be output.
//</p>
//<p>
//The plot used to display the Haar waveletTest spectrums is modeled after
...
//same number of points.  The waveletTest spectrum is graphed over the
